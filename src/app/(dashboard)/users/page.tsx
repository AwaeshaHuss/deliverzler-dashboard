                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => handleModerateClick(user)}>
                          Moderate
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
      ...
      <AlertDialog open={isModerationOpen} onOpenChange={setIsModerationOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Review user activity and use the AI tool to check for behavior that violates community standards.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="space-y-4 text-sm">
            <p className="font-medium">User Activity Summary:</p>
            <p className="p-3 bg-muted rounded-md border text-muted-foreground">{selectedUser?.activitySummary}</p>
            {isModerating ? (
              <div className="space-y-2">
              ...
              <div className={`p-3 rounded-md border ${moderationResult.blockUser ? 'border-destructive/50 bg-destructive/10' : 'border-green-500/50 bg-green-500/10'}`}>
                <p className="font-medium">AI Recommendation:</p>
                <p className={moderationResult.blockUser ? 'text-destructive' : 'text-green-700'}>{moderationResult.reason}</p>
              </div>
            )}
          </div>
          <AlertDialogFooter>
